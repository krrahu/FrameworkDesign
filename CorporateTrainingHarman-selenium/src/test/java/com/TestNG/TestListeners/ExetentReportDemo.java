...
public class ExetentReportDemo {
  ...
  public void createReport() 
  {
	  ...
	  //(when we will attached the report then only it will  generate report so below code is required)
	  
	  extent.attachReporter(spark);
	  
	  //create a test to set the log
	  
	 ExtentTest test= extent.createTest("CRM Appliaction Test");  // extent is class object
	 ...
	 //flush()  --> to close the extent report method 
	 extent.flush();
